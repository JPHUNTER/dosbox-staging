...
# Reelmagic Patch Overview

This patch has been shoehorned in from a fork of old DOSBox in order to run ReelMagic games. It would appear
...
* `src/hardware/meson.build`              -- Declared new ReelMagic *.cpp source code files
