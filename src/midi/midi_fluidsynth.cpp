...
// Return a deque of existing soundfont paths from the comma-separated list of
// names
...
bool MidiHandlerFluidsynth::Open([[maybe_unused]] const char *conf)
{
	...
	// Check if the user provided a scaling parameter for the collection of soundfonts
