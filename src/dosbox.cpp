...
void DOSBOX_Init() {
	...
	Pstring->Set_help("Filter for the PC speaker DAC output:\n"
	                  "  on:    Filter the output (default).\n"
	                  "  none:  Don't filter the output.");
	...
	Pstring = secprop->Add_string("tandy_psg_filter", when_idle, "on");
	Pstring->Set_help("Filter for the Tandy PSG output:\n"
	                  "  on:    Filter the output (default).\n"
	                  "  none:  Don't filter the output.");
	...
	Pstring = secprop->Add_string("ps1audio_psg_filter", when_idle, "on");
	Pstring->Set_help("Filter for the PS/1 Audio PSG output:\n"
	                  "  on:    Filter the output (default).\n"
	                  "  none:  Don't filter the output.");
